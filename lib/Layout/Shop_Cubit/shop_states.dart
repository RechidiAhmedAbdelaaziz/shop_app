...
class LoadingSearchDataState extends ShopStates {}
class SuccessSearchDataState extends ShopStates {}
class ErorrSearchDataState extends ShopStates {
  final String erorr;
  ErorrSearchDataState(this.erorr);
}
